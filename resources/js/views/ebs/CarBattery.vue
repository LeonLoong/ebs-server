...
import { getCarBatteries, getBatteryManufacturers, getBatterySeries, getBatteryTypes, getBatteryTradeIns } from '@/api/ebs';
...
export default {
  ...
  data() {
    return {
      ...
      carID: this.$route.params && this.$route.params.carID,
      batteries: [],
      manufacturer_list: [],
      series_list: [],
      type_list: [],
  ...
  methods: {
    async getData() {
      getCarBatteries(this.query, this.carID)
        .then(response => {
          this.loading = true;
