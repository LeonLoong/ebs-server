<template>
  <div class="app-container">
    ...
    <el-dialog :visible.sync="addDialogVisible" :title="'Add New Battery Model'" :close-on-click-modal="false">
...
import { getBatteries, storeBattery, updateBattery, destroyBattery, getBatteryManufacturers, getBatterySeries, getBatteryTypes, getBatteryTradeIns } from '@/api/ebs';
